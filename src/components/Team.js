...
function Team() {
  return (
    <div name='team' className="p-5 bg-gray-100 dark:bg-[#0C1017]">
      <h1 className="text-5xl text-center mt-3 dark:text-white text-black font-bold tracking-wide mb-5 pt-5">Team</h1>
