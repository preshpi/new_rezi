  ...
  return (
    ...
    <div className="grid lg:grid-cols-2 lg:m-10 m-5 place-items-center justify-center">
        <div data-aos="fade-left">
            <p className=" dark:text-white text-black tracking-wide leading-9 lg:text-start text-xl  lg:text-2xl w-[350px] md:w-[400px] lg:w-[600px] text-center">
             Regiscoin is a token owned by Regiz LLC.
            </p>

            <p className=" dark:text-white text-black mt-3  tracking-wide leading-9 lg:text-start text-xl  lg:text-2xl w-[330px] md:w-[400px] lg:w-[600px] text-center">
